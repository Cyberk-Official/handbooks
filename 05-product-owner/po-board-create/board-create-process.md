...
- Ngay sau khi [Internal Planning](../po-planning/planning-process.md) hoàn tất — **trước khi tạo task đầu tiên**.
...
|---------|---------------------|
| **PO / Tech Lead** | Cung cấp input (tên dự án, epics, milestones, members). Review board. Thiết lập views. Thông báo team |
...
|---|----------|--------|--------|
| 1 | **Chuẩn bị input:** Tên dự án, danh sách Epic, Milestones, GitHub ID members | PO/TL | Input sẵn sàng |
| 2 | **Prompt AI tạo board:** Cung cấp input → AI chạy GH CLI tạo project + 2 custom fields bắt buộc (Epic, Milestone) + 2 optional (Week, Estimate) | AI + PO | Project + fields sẵn sàng |
| 3 | **Thiết lập 3 Views trên GitHub UI:** Sprint Board, Bugs Board, Personal Board cho mỗi member | PO/TL | 3 views hoạt động |
| 4 | **Verify & thông báo:** Kiểm checklist → gửi link board qua Telegram | PO/TL | Team confirm |
...
| **Target date** *(optional)* | Date | ✅ | Hạn chót — dùng khi cần track deadline cụ thể |
...
| **5 fields bắt buộc + 3 optional (Target date, Week, Estimate)** | Thiếu bắt buộc = không filter được. Thêm không cần = team không điền |
...
- [Internal Planning — Họp nội bộ (bước trước)](../po-planning/planning-process.md)
