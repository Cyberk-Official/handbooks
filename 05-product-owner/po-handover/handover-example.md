...
|--------|-----|---------|-----------------|
| Product Owner | [Tên PO] | [email/Telegram] | Mọi vấn đề chung |
...
>
> PO: *"Great question. For critical issues that affect your users, we'll always respond quickly. We can set up a support arrangement that works for both sides."*
