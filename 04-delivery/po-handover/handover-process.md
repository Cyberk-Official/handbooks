...
|---------|---------------------|
| Product Owner / PO | Điều phối toàn bộ, liên hệ client, chuẩn bị slide, gửi email tổng kết |
...
|---|----------|--------|-----------------|
| 1 | **Chuẩn bị tài liệu, slide, đóng gói repository** — tài liệu handover, slide tổng kết dự án, repo sạch sẽ có README | PO + TL + Dev | Slide deck, handover doc, repo đóng gói |
| 2 | **Hẹn lịch call với khách hàng, kèm nội dung trước** — gửi trước ít nhất 1 ngày làm việc, đính kèm agenda để client biết sẽ thảo luận gì | PO | Lịch hẹn + agenda gửi client (xem [mẫu tin nhắn](./handover-example.md)) |
| 3 | **Call với khách hàng — thảo luận, làm rõ** — demo sản phẩm trên production, walk through tài liệu handover, giải thích maintenance policy, open talk | PO + TL + Dev | Buổi bàn giao hoàn tất, action items ghi nhận |
| 4 | **Gửi email tổng kết** — recap buổi họp, đính kèm toàn bộ tài liệu, liệt kê action items, nhắc lại maintenance timeline | PO | Email tổng kết (xem [mẫu email](./handover-example.md)) |
